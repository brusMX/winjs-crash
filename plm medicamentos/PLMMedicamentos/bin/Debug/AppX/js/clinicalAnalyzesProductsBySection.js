...
(function () {
    ...
    WinJS.UI.Pages.define("/pages/clinicalAnalyzes/clinicalAnalyzesProductsBySection.html", {
        ...
        ready: function (element, options) {
            ...
            var sectionNameElement = document.querySelector("#sectionName");
            if(sectionNameElement != null && sectionNameElement != undefined){
                sectionNameElement.innerHTML = clinicalAnalyzesVars.sectionName;
            }
            ...
            function displayProductsBySection(products) {
                if (products.length > 0 && products != null && products != 'undefined') {
                    ...
                    var productsList = document.getElementById("productsBySection");

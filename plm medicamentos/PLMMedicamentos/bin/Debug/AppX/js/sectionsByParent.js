...
(function () {
    ...
    WinJS.UI.Pages.define("/pages/clinicalAnalyzes/sectionsByParent.html", {
        // Se llama a esta función cuando un usuario navega a esta página. Esta
        // rellena los elementos de la página con los datos de la aplicación.
        ready: function (element, options) {
            // TODO: Inicializar la página aquí.
            var sectionsData = {};
            document.body.querySelector("#sectionName").innerHTML = clinicalAnalyzesVars.sectionParentName;
            ...
            function getSectionsByParent(args) {
                ...
                WinJS.Navigation.navigate('/pages/clinicalAnalyzes/productsBySection.html');
            }

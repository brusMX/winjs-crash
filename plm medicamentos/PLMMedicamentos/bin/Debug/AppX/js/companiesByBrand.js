...
(function () {
    ...
    WinJS.UI.Pages.define("/pages/clinicalAnalyzes/companiesByBrand.html", {
        ...
        ready: function (element, options) {
            ...
            getCompaniesByBrand();
            document.querySelector("#brandName").innerHTML = clinicalAnalyzesVars.brandName;
            ...
            function displayCompaniesByBrand(companies) {
                ...
                if (companies.length > 0 && companies != null && companies != 'undefined') {
                    ...
                    var companiesList = document.getElementById("companies").winControl;

...
(function () {
    ...
    WinJS.UI.Pages.define("/pages/clinicalAnalyzes/clinicalAnalyzesCompanyDetail.html", {
        ...
        ready: function (element, options) {
            ...
            function displayCompanyDetail(company) {
                ...
                if (company != null && company != undefined) {
                    ...
                    if (company.Products.length > 0) {
                        clinicalAnalyzesVars.ProductByEditionInfoItems = company.Products;
                        companyDetail += '<div class="center"><button id="companyProducts" class="win-button">Productos</button></div>';
                    }
                ...
                var companyDetailElement = document.body.querySelector("#companyDetail");
                if (companyDetailElement != null && companyDetailElement != undefined){
                    companyDetailElement.innerHTML = companyDetail;
                }
                Loader.hide();
                var companyProductsElement = document.querySelector("#companyProducts");
                if (clinicalAnalyzesVars.ProductByEditionInfoItems != null && companyProductsElement != null && companyProductsElement != undefined)
                    companyProductsElement.addEventListener("click", displayCompanyProducts, false);
                if (webPage.length > 0) {
                    for (var i = 0; i < webPage.length; i++) {
            ...
            function displayCompanyProducts() {
                ...
                Loader.show();
                WinJS.Navigation.navigate('/pages/clinicalAnalyzes/clinicalAnalyzesCompanyProducts.html');
            }

...
(function () {
    ...
    WinJS.UI.Pages.define("/pages/clinicalAnalyzes/clinicalAnalyzesCompaniesByBrand.html", {
        ...
        ready: function (element, options) {
            ...
            var brandNameElment = document.querySelector("#brandName");
            if (brandNameElment != null && brandNameElment != undefined){
                brandNameElment.innerHTML = clinicalAnalyzesVars.brandName;
            }
            ...
            function callback(responseText, status) {
                if (status === 200) {
                    if (responseText != "") {
                        ...
                        displayCompaniesByBrand(items.getCompaniesByBrandResult);
                    } else {
                        Loader.hide();
            ...
            function getCompaniesByBrand() {
                console.log("getCompaniesByBrand");
                return new WinJS.Promise(function (completed, error, progress) {
                    Connectivity.test().then(function () {
                        var options = {
                            url: RESTServices.ClinicalAnalyzesEngine + '/getCompaniesByBrand?code=' + globalVars.code + "&ISBN=" + globalVars.clinicalAnalyzesISBN + "&brandId=" + clinicalAnalyzesVars.brandId,
                            type: 'GET'
                        };
            ...
            function displayCompaniesByBrand(companies) {

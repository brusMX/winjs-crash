...
(function () {
    ...
    WinJS.UI.Pages.define("/pages/clinicalAnalyzes/manufacturersAndDistributors.html", {
        // Se llama a esta función cuando un usuario navega a esta página. Esta
        // rellena los elementos de la página con los datos de la aplicación.
        ready: function (element, options) {
            // TODO: Inicializar la página aquí.
            var statesData = {};
            clinicalAnalyzesVars.companyTypeId = 3;
            console.log(globalVars.countryId);
            ...
            function displayStates(states) {
                ...
                if (states.length > 0 && states != null && states != 'undefined') {
                    ...
                    var statesList = document.getElementById("states").winControl;
            ...
            function getCitiesByStateBySection(args) {
                ...
                WinJS.Navigation.navigate('/pages/clinicalAnalyzes/CitiesByState.html');
            }

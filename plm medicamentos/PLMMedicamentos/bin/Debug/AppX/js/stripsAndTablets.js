...
(function () {
    ...
    WinJS.UI.Pages.define("/pages/clinicalAnalyzes/stripsAndTablets.html", {
        // Se llama a esta función cuando un usuario navega a esta página. Esta
        // rellena los elementos de la página con los datos de la aplicación.
        ready: function (element, options) {
            // TODO: Inicializar la página aquí.
            var sectionsData = {};
            var sectionIdParent = 11;
            ...
            function callback(responseText, status) {
                if (status === 200) {
                    if (responseText != "") {
                        ...
                        var messageDialog = new Windows.UI.Popups.MessageDialog("No se encontraron secciones.");

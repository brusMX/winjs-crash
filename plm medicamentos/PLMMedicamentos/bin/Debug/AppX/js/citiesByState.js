...
(function () {
    ...
    WinJS.UI.Pages.define("/pages/clinicalAnalyzes/CitiesByState.html", {
        ...
        ready: function (element, options) {
            ...
            document.body.querySelector("#stateName").innerHTML = clinicalAnalyzesVars.stateName;
            ...
            function displayCities(cities) {
                if (cities.length > 0 || cities != null && cities != 'undefined') {
                    ...
                    var citiesList = document.getElementById("cities").winControl;
            ...
            function getCompaniesByCity(args) {
                ...
                WinJS.Navigation.navigate('/pages/clinicalAnalyzes/companiesByCity.html');
            }

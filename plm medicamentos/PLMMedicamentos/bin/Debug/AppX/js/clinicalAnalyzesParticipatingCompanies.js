...
(function () {
    ...
    WinJS.UI.Pages.define("/pages/clinicalAnalyzes/clinicalAnalyzesParticipatingCompanies.html", {
        ...
        ready: function (element, options) {
            ...
            function displayCompanies(companies) {
                ...
                if (companies != null && companies != 'undefined') {
                    ...
                    var list2 = document.getElementById("participatingCompanies");    //Lista a la que hacemos referencia

...
(function () {
    ...
    WinJS.UI.Pages.define("/pages/clinicalAnalyzes/clinicalAnalyzesSectionsByParent.html", {
        // Se llama a esta función cuando un usuario navega a esta página. Esta
        // rellena los elementos de la página con los datos de la aplicación.
        ready: function (element, options) {
            // TODO: Inicializar la página aquí.
            var sectionsData = {};
            var sectionNameElement = document.body.querySelector("#sectionName");
            if(sectionNameElement != null && sectionNameElement != undefined){
                sectionNameElement.innerHTML = clinicalAnalyzesVars.sectionParentName;
            }
            ...
            function callback(responseText, status) {
                if (status === 200) {
                    if (responseText != "") {
                        ...
                        var messageDialog = new Windows.UI.Popups.MessageDialog("No se encontraron subsecciones disponibles.");
                    ...
                    WinJS.Navigation.back(1);
                    messageDialog.showAsync();
                    var messageDialog = new Windows.UI.Popups.MessageDialog("Hubo un error en el servicio al intentar recuperar las subsecciones.");
                    messageDialog.commands.append(new Windows.UI.Popups.UICommand("Aceptar"));
                    messageDialog.showAsync();
                }
            }
            ...
            function getSectionsByParentId() {
                ...
                return new WinJS.Promise(function (completed, error, progress) {
                    Connectivity.test().then(function () {
                        var options = {
                            url: RESTServices.ClinicalAnalyzesEngine + '/getSectionsByParentId?code=' + globalVars.code + "&ISBN=" + globalVars.clinicalAnalyzesISBN + "&sectionIdParent=" + clinicalAnalyzesVars.sectionParentId,
                            type: 'GET'
                        };

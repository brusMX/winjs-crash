    ...
    WinJS.UI.Pages.define("/pages/healthcareSuppliers/healthcareSuppliersClientDetail.html", {
        ...
        ready: function (element, options) {
            ...
            function displayCompanyDetail(clients) {
                    ...
                    if (clients.Addresses.length > 0) {
                        ...
                        for (var i = 0; i < clients.Addresses.length; i++) {
                            ...
                            if (clients.Addresses[i].Web != '') {
                                clientDetail += '<p><b>Direcci&oacute;n web:</b>';
                ...
                var categories = document.querySelector("#categoriesButton");
                var brands = document.querySelector("#brandsButton");
                console.log(categories);
                if (healthcareSuppliersVars.categories.length > 0 && categories != undefined && categories != null) {
                    categories.addEventListener("click", displayCategories, false);
                }
                if (healthcareSuppliersVars.brands.length > 0 && brands != undefined && brands != null) {

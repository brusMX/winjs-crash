...
(function () {
    ...
    WinJS.UI.Pages.define("/pages/healthcareSuppliers/healtcareProductsMenu.html", {
        ...
        ready: function (element, options) {
            ...
            getBrandsByLetterOrText(clinicalAnalyzesVars.letter);
            ...
            function getBrandsByLetterOrText(letter) {
                ...
                return new WinJS.Promise(function (completed, error, progress) {
                    Connectivity.test().then(function () {
                        ...
                        var options = {
                            url: RESTServices.HealthcareSuppliersEngine + '/getBrandsByLetterOrText?code=' + globalVars.code + "&editionId=" + healthcareSuppliersVars.editionId
                                + "&description=" + letter,
                            type: 'GET'
                        };
            ...
            function displaySectionsByIndex(sectionsList) {
                if (sectionsList.length > 0 && sectionsList != null && sectionsList != 'undefined') {
                    ...
                    document.body.querySelector('#productsList').style.display = "none";
                } else {
                    document.body.querySelector('#productsList').style.display = "block";
                }

        ...
        ready: function (element, options) {
            ...
            function displayProductContent(productDetails) {
                ...
                if(productNameElement != null && productNameElement != undefined){
                    productNameElement.innerHTML = '<b>' + productDetails.ProductName + '</b>';
                }
                ...
                for (var i = 0; i < productDetails.AttributeGroups.length; i++) {
                    /*attributes += '<div class="attribute" onclick="showAttibute(' + i + ')" id="attributeName' + i + '">' + productDetails.AttributeGroups[i].AttributeGroupName +
    				'<div style="display: none;" id="HTMLContent' + i + '">' + productDetails.AttributeGroups[i].AttributeGroupHTMLContent + '</div></div>';*/


                    attributes += '<div>' +
                        '<h4 class="expandable-menu" onclick="showAttibute(' + i + ')" id="attributeName' + i + '">' + productDetails.AttributeGroups[i].AttributeGroupName +
                            '<span class="icon-status" id="productsListSpan' + i + '">+</span></h4>' +
                        '<div style="display: none;" id="HTMLContent' + i + '">' + productDetails.AttributeGroups[i].AttributeGroupHTMLContent + '</div></div>';

...
(function () {
    ...
    WinJS.UI.Pages.define("/pages/clinicalAnalyzes/clinicalAnalyzesLaboratoriesDirectory.html", {
        // Se llama a esta función cuando un usuario navega a esta página. Esta
        // rellena los elementos de la página con los datos de la aplicación.
        ready: function (element, options) {
            // TODO: Inicializar la página aquí.
            var statesData = {};
            clinicalAnalyzesVars.companyTypeId = 5;
            ...
            function getStatesBySection() {
                ...
                return new WinJS.Promise(function (completed, error, progress) {
                    Connectivity.test().then(function () {
                        var options = {
                            url: RESTServices.ClinicalAnalyzesEngine + '/getStatesBySection?code=' + globalVars.code + "&ISBN=" + globalVars.clinicalAnalyzesISBN + "&countryId="
                                + clinicalAnalyzesVars.countryId + "&companyTypeId=" + clinicalAnalyzesVars.companyTypeId,
                            type: 'GET'
                        };
                        console.log(options);
